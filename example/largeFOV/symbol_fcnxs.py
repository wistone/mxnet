...
def vgg16_score(input, numclass, workspace_default=1024):
    ...
    # group 6
    fc6 = mx.symbol.Convolution(data=pool5a, kernel=(3, 3), pad=(2,2), dilate=(2,2), num_filter=1024,
...
def fcnxs_score(input, crop, offset, kernel=(64,64), stride=(32,32), numclass=21, workspace_default=1024):
    # score out
    bigscore = mx.symbol.Deconvolution(data=input, kernel=(17,17), stride=(8,8), pad=(8,8), num_filter=numclass,
